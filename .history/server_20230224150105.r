...
output$AdvancedSS_addcomms_user<- renderUI({ 
        fluidRow(column(width=6, prettyCheckbox(
        inputId = "add_comms", label = "Add additional",tags$a(href="javascript:window.open('SS_commands.html', '_blank','width=600,height=400')", " SS run commands")," (e.g., -hess_step 5)",
        shape = "round", outline = TRUE, status = "info"))) 
  }) 
