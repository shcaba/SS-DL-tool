...
shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed_est_tog",
  ...
  shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed",
    h4(strong("Life history inputs")),
        ...
        h5("Length-fecundity relationship F=aL^b. Fecundity is measured in number of eggs or pups. Set equal to the W-L relationship to get fecundity equivalent to spawning biomass."),
