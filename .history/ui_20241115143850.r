  ...
  shinyUI(fluidPage(
    ...
    sidebarLayout(
      sidebarPanel(
       ...
       fluidRow(column(width=12,fileInput('file33', 'Ageing error file. No file assumes age data are unbiased and precise.',
                           accept = c(
                             'text/csv',
                             'text/comma-separated-values',
                             'text/tab-separated-values',
...
#fluidRow(h5("Software to calculate ageing error matrices from multiple age reads is available ", tags$a(href = "https://github.com/pfmc-assessments/nwfscAgeingError", "here", target = "_blank"), ".")),
fluidRow(style = "padding-right:50px;padding-left:50px;padding-top:0px; padding-bottom:-10000px;", h6("Software to calculate ageing error matrices from multiple age reads is available ", tags$a(href = "https://github.com/pfmc-assessments/nwfscAgeingError", "here", target = "_blank"), ".")),
 ...
 #         uiOutput("AdvancedSS_ageerror_in"),
        ...
        shinyjs::hidden(wellPanel(
          ...
          wellPanel(
            ...
            fluidRow(
              column(width = 6, numericInput("Linf_f", "Asymptotic size (Linf)", value = NA, min = 0, max = 10000, step = 0.001)),
              column(width = 6, numericInput("k_f", "Growth coefficient k", value = NA, min = 0, max = 10000, step = 0.00001))
            ),
            fluidRow(
              column(width = 6, numericInput("t0_f", "Age at length 0 (t0)", value = NA, min = -100, max = 10000, step = 0.001)),
              column(width = 6, textInput("CV_lt_f", "CV at length (young then old)", value = "0.1,0.1"))
            ),
            fluidRow(
              column(width = 6, numericInput("L50_f", "Length at 50% maturity", value = NA, min = 0, max = 10000, step = 0.001)),
        ...
        shinyjs::hidden(wellPanel(
          ...
          wellPanel(
            ...
            fluidRow(
              column(width = 6, numericInput("Linf_f_fix", "Asymptotic size (Linf)", value = NA, min = 0, max = 10000, step = 0.001)),
              column(width = 6, numericInput("k_f_fix", "Growth coefficient k", value = NA, min = 0, max = 10000, step = 0.00001))
            ),
            fluidRow(
              column(width = 6, numericInput("t0_f_fix", "Age at length 0 (t0)", value = NA, min = 0, max = 10000, step = 0.001)),
              column(width = 6, textInput("CV_lt_f_fix", "CV at length (young then old)", value = "0.1,0.1"))
            ),
            fluidRow(
              column(width = 6, numericInput("L50_f_fix", "Length at 50% maturity", value = NA, min = 0, max = 10000, step = 0.001)),
          ...
          wellPanel(
            ...
            fluidRow(
              column(width = 6, numericInput("WLa_f_fix", "a in W=aL^b", value = 0.00001, min = 0, max = 10000, step = 0.000000001)),
            ...
            fluidRow(
              column(width = 6, numericInput("Fec_a_f_fix", "a in F=aL^b", value = 0.00001, min = 0, max = 10000, step = 0.000000001)),
          ...
          fluidRow(
            column(width = 6, checkboxInput("male_parms_fix", "Males specific values?", FALSE)),
        ...
        shinyjs::hidden(wellPanel(
          ...
          wellPanel(
            ...
            fluidRow(
              column(width = 6, numericInput("L50_f_est", "Length at 50% maturity", value = NA, min = 0, max = 10000, step = 0.001)),
              column(width = 6, numericInput("L95_f_est", "Length at 95% maturity", value = NA, min = 0, max = 10000, step = 0.001))
            ),
            h5("Length-weight relationship W=aL^b. Weight is in kg and length in cm."),
            fluidRow(
              column(width = 6, numericInput("WLa_f_est", "a in W=aL^b", value = 0.00001, min = 0, max = 10000, step = 0.000000001)),
              column(width = 6, numericInput("WLb_f_est", "b in W=aL^b", value = 3, min = 0, max = 10000, step = 0.001))
            ),
            h5("Length-fecundity relationship F=aL^b. Fecundity is measured in number of eggs or pups. Set equal to the length-weight relationship to get fecundity equivalent to spawning biomass."),
            fluidRow(
              column(width = 6, numericInput("Fec_a_f_est", "a in F=aL^b", value = 0.00001, min = 0, max = 10000, step = 0.000000001)),
          ...
          h5(em("If estimating females and wanting to match males to estimated female parameters, use the male offset option and set offsets to 0. This will ensure male values are equal to estimated female males. Otherwise, males will retain the initial female values.")),
          fluidRow(
            column(width = 6, checkboxInput("male_parms_est", "Males specific values?", FALSE)),
        ...
        shinyjs::hidden(wellPanel(
          ...
          wellPanel(
            ...
            h5(strong("Maturity and weight-length relationships")),
            fluidRow(
              column(width = 6, numericInput("L50_f_sss", "Length at 50% maturity", value = NA, min = 0, max = 10000, step = 0.001)),
              column(width = 6, numericInput("L95_f_sss", "Length at 95% maturity", value = NA, min = 0, max = 10000, step = 0.001))
            ),
            h5("Length-weight relationship W=aL^b. Weight is in kg and length in cm."),
            fluidRow(
              column(width = 6, numericInput("WLa_f_sss", "a in W=aL^b", value = 0.00001, min = 0, max = 10000, step = 0.000000001)),
              column(width = 6, numericInput("WLb_f_sss", "b in W=aL^b", value = 3, min = 0, max = 10000, step = 0.001))
            ),
            h5("Length-fecundity relationship F=aL^b. Fecundity is measured in number of eggs or pups. Set equal to the length-weight relationship to get fecundity equivalent to spawning biomass."),
            fluidRow(
              column(width = 6, numericInput("Fec_a_f_sss", "a in F=aL^b", value = 0.00001, min = 0, max = 10000, step = 0.000000001)),
              column(width = 6, numericInput("Fec_b_f_sss", "b in F=aL^b", value = 3, min = 0, max = 10000, step = 0.001))
            ),
          ),
          fluidRow(
            column(width = 10, checkboxInput("male_parms_SSS", "Males specific values?", FALSE)),
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(
            column(width = 6, numericInput("h_LO", "Steepness", value = 0.7, min = 0.2, max = 1, step = 0.01)),
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(
            column(width = 4, numericInput("h", "Steepness", value = 0.7, min = 0.2, max = 1, step = 0.01)),
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(
            column(width = 6, numericInput("lnR0_est", "Log initial recruitment", value = 7, min = 0, max = 20, step = 0.01)),
      ...
      input[type='checkbox']{ /* style for checkboxes */
        ...
        shinyjs::hidden(wellPanel(
          ...
          p("If using a mix of logistic and dome-shaped selectivities, select", strong("dome-shaped"), "and use the default values (10000,0.0001,0.9999 for the additional parameters, respectively) to achieve a logistic shape for any given fleet."),
          br(),
        ...
        shinyjs::hidden(wellPanel(
          ...
          p("If using a mix of logistic and dome-shaped selectivities, select", strong("dome-shaped"), "and pre-specify (i.e., use a negative phase) the provided default values (10000,0.0001,0.9999 for the additional parameters, respectively) to achieve a logistic shape for any given fleet."),
          br(),
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(
            column(width = 4, popify(uiOutput("AdvancedSS_noplots"), "Output plots", "Diagnostic and results plots are produced by default. This switch turns those plots off in case you want to speed up the model run.")),
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(
            column(width = 4, popify(uiOutput("AdvancedSS_noplots_user"), "Output plots", "Diagnostic and results plots are produced by default. This switch turns those plots off in case you want to speed up the model run.")),
          ...
          popify(uiOutput("AdvancedSS_forecastnew_user"), "Overwrite the forecast.ss file with the forecast.ss_new file.", "This file is a copy of the forecast file used in the previous run. In the event you want to use this file, this switch will overwrite the forecast file content with what is in the forecast.ss_new."),
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(
            column(width = 5, numericInput("iter", "How many iterations to run?", value = 2000, min = 1, max = 1000000000000, step = 1)),
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(
            column(width = 4, textInput("Prof_Low_val", "Low value", value = "")),
          ...
          fluidRow(
            column(width = 5, numericInput("TRP_multi_like", "Target reference point (max = 1; 0 = no plot)? ", value = 0, min = 0, max = 1, step = 0.001)),
        ...
        shinyjs::hidden(wellPanel(
          ...
          h5(em("Retrospective modelling means sequentially removing one year of data up to a specified number of years (e.g., -10 years).")),
          ...
          fluidRow(
            column(width = 6, numericInput("first_retro_year_in", "1st retrospective year", value = -1, min = -500, max = 0, step = 1)),
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(
            column(width = 6, numericInput("SensiRE_ymin", strong("Minimum y-axis value"), value = -1, min = -100, max = 100, step = 0.01)),
          ...
          fluidRow(
            column(width = 8, textInput("SensiRE_headers", strong("Subheader names"), value = " ")),
            column(width = 4, numericInput("SensiRE_headers_text", strong("Text size"), value = 2, min = 0.01, max = 10, step = 0.01))
          ),
          fluidRow(
            column(width = 6, textInput("SensiRE_xcenter", strong("Vertical (x) centering of headers"), value = " ")),
