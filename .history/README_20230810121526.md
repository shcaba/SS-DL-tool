...
"data.table","adnuts","shinystan","shinyBS","gt","gtExtras","stringr", dependencies = TRUE)
...
The Rcpp package can often throw errors. It is recommended to run this line of code to make sure all dependencies for this library are included.
