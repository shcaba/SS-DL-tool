...
{  
  ...
  output$Ltplot<-renderPlot({ 
      ...
      #  }
       ...
       if(!is.na(L50()))Lt.dat.plot.L50[Lt.dat.plot.L50$sex==0|Lt.dat.plot.L50$sex==1]<-L50()
       if(is.na(L50()))Lt.dat.plot.L50[Lt.dat.plot.L50$sex==0|Lt.dat.plot.L50$sex==1]<-(-1)
       Lt.dat.plot.L50[Lt.dat.plot.L50$sex==2]<-(-1)
