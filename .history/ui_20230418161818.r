...
shinyjs::hidden(wellPanel(id="Data_panel",
 ...
 fluidRow(column(width=12,fileInput('file2', 'Catch time series',
  ...
  h5(em("Using an existing model allows you to do run complex and custom model runs outside the options of the SS-DL tool, but still use some of quick features.")),
