...
if(length(grep("top_logit",rownames(xx$estimated_non_dev_parameters)))>0)
  {
    ...
    Est.sel.tranformed$Value[grep("top_logit",rownames(xx$estimated_non_dev_parameters))]<-Est.sel.peak-sqrt(-exp(Est.sel.Sel50)*log(0.5))
...
if(length(grep("descend",rownames(xx$estimated_non_dev_parameters)))>0)
  {
    ...
    Est.sel.tranformed$Value[grep("descend",rownames(xx$estimated_non_dev_parameters))]<-Est.sel.peak-sqrt(-exp(Est.sel.Sel50)*log(0.5))
...
if(length(grep("end_logit",rownames(xx$estimated_non_dev_parameters)))>0)
  {
    ...
    Est.sel.tranformed$Value[grep("end_logit",rownames(xx$estimated_non_dev_parameters))]<-Est.sel.peak-sqrt(-exp(Est.sel.Sel50)*log(0.5))
