...
output$AdvancedSS_ageerror<- renderUI({ 
        ...
        inputId = "Ageing_error_choice", label = "Add custom ageing error matrices? Software available",tags$a(href="https://github.com/pfmc-assessments/nwfscAgeingError", "here.",
        shape = "round", outline = TRUE, status = "info"))) 
  }) 
