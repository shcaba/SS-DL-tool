...
#      tags$ul(tags$li(h5(p(em("If using only length or age data, starting model year is based on earliest year minus age at 95% Linf"))))),
  ...
  h5(p(strong("Worried about losing your session inputs? Click the save session button before running the model to save your inputs. To recovery those inputs, you can paste the link into another webpage. Note you will need to reload your data files to see the inputs."))),
