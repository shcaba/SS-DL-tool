...
#      tags$ul(tags$li(h5(p(em("If using only length or age data, starting model year is based on earliest year minus age at 95% Linf"))))),
    ...
    #fluidRow(column(width=10,checkboxInput("advance_ss_click","Advanced SS options",FALSE))),
      ...
      popify(uiOutput("AdvancedSS_plots_RP"),"Target and limit reference points specification","The relative stock size target and limit reference points can be . The default values are and 0.4 and 0.25"),
      popify(uiOutput("AdvancedSS_plots_RP_inputs"),"Target and limit reference points specification","The relative stock size target and limit reference points can be . The default values are and 0.4 and 0.25"),
