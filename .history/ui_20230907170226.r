...
shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed_est_tog",
  ...
  shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed",
    h4(strong("Life history inputs")),
        ...
        h4(strong(em("Male"))),
        h5("If estimating females and wanting to match males to estimated female parameters, use the male offset option and set offsets to 0. This will ensure male values are equal to estimated female males. Otherwise, males will retain the initial female values.")
