...
########################
  ...
  shinyjs::hidden(wellPanel(id="Modeff_panel",
    ...
    br(),
    br(),
    h5(strong("Choose Bayesian method to use")),
    dropdownButton(
          selectInput("modeff_type","Method",c("Random walk (rwm)","No u-turn (nuts)")),
          circle = FALSE, right=TRUE, status = "danger", icon = icon("skull-crossbones"), width = "300px",label="Method"
            ),
