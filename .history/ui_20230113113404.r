...
shinyUI(fluidPage(theme = "bootstrap.css",
  ...
  titlePanel("Welcome to the Stock Synthesis data-limited tool (SS-DL tool)"),
      h5(p(strong("This tool uses the Stock Synthesis framework to implement a ",tags$a(href="javascript:window.open('SS-DL-approaches.html', '_blank','width=600,height=400')", "variety of types"), "of models:"))),
...
shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed_est_tog",
  ...
  shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed",
    h4(strong("Life history inputs")),
        ...
        h5("Fecundity-length relationship F=aL^b. Set equal to the W-L relationship to get fecundity equivalent to spawning biomass"),
        fluidRow(column(width=6,numericInput("Fec_a_f_fix", "Coefficent a", value=0.00001,min=0, max=10000, step=0.000000001)),
                column(width=6,numericInput("Fec_b_f_fix","Exponent b", value=3,min=0, max=10000, step=0.0001))),
        fluidRow(column(width=6,numericInput("WLa_f_fix", "Weight (kg)-Length (cm): a in W=aL^b", value=0.00001,min=0, max=10000, step=0.000000001)),
                column(width=6,numericInput("WLb_f_fix","Weight (kg)-Length (cm): b in W=aL^b", value=3,min=0, max=10000, step=0.0001))),    
...
#      fluidRow(column(width=10,switchInput("est_parms2","Estimate parameters?",value=TRUE))),      
    ...
    h5(strong("Maturity and weight-length relationships")),            
      fluidRow(column(width=6,numericInput("L50_f_est", "Length at 50% maturity", value=NA,min=0, max=10000, step=0.001)),
        ...
        h5("Fecundity-length relationship F=aL^b. Set equal to the W-L relationship to get fecundity equivalent to spawning biomass"),
        fluidRow(column(width=6,numericInput("Fec_a_f_est", "Coefficient a", value=0.00001,min=0, max=10000, step=0.000000001)),
              column(width=6,numericInput("Fec_b_f_est","Exponent b", value=3,min=0, max=10000, step=0.001))),    
      fluidRow(column(width=6,numericInput("WLa_f_est", "Weight (kg)-Length (cm): a in W=aL^b", value=0.00001,min=0, max=10000, step=0.000000001)),
              column(width=6,numericInput("WLb_f_est","Weight (kg)-Length (cm) beta: b in W=aL^b", value=3,min=0, max=10000, step=0.001))),    
    ),
   ...
   #  ),
    ...
    h5(strong("Maturity and weight-length relationships")),            
      ...
      h5("Fecundity-length relationship F=aL^b. Set equal to the W-L relationship to get fecundity equivalent to spawning biomass"),
      fluidRow(column(width=6,numericInput("Fec_a_f_sss", "Cofficient a", value=0.00001,min=0, max=10000, step=0.000000001)),
              column(width=6,numericInput("Fec_b_f_sss","Exponent b", value=3,min=0, max=10000, step=0.001))),    
      fluidRow(column(width=6,numericInput("WLa_f_sss", "Weight (kg)-Length (cm): a in W=aL^b", value=0.00001,min=0, max=10000, step=0.000000001)),
              column(width=6,numericInput("WLb_f_sss","Weight (kg)-Length (cm): b in W=aL^b", value=3,min=0, max=10000, step=0.001))),    
    ),
