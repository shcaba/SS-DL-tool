...
{  
  ...
  output$Ltplot<-renderPlot({ 
      ...
      #  colnames(Lt.dat.plot.L50)<-colnames(Lt.dat.plot.Linf)<-c("year","fleet","sex","name","Year")
      ...
      #  Lt.dat.plot.L50[Lt.dat.plot.L50$sex==0|Lt.dat.plot.L50$sex==1|]<-L50()
      #  Lt.dat.plot.L50[Lt.dat.plot.L50$sex==0|Lt.dat.plot.L50$sex==2|]<-(-1)
