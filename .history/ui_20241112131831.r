...
#popify(uiOutput("AdvancedSS_ageerror"), "Ageing error matrices.", "Add as many custom ageing error matrices as needed. See the folders Example data files --> ageing error matrices for examples of the ageing error input."),
 #         uiOutput("AdvancedSS_ageerror_in"),
          ...
          fluidRow(
            column(width = 2.4, actionButton("reset_ct", "Catches")),
            column(width = 2.4, actionButton("reset_lt", "Length")),
            column(width = 2.4, actionButton("reset_age", "Ages")),
            column(width = 2.4, actionButton("reset_age_err", "Ages Error")),
            column(width = 2.4, actionButton("reset_index", "Index"))
          ),
        )),
        shinyjs::hidden(wellPanel(
          id = "Existing_files",
