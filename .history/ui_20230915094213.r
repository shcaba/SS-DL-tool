...
shinyUI(fluidPage(theme = "bootstrap.css",
  useShinyjs(),
  titlePanel("Welcome to the Stock Assessment Continuum Tool, powered by" ,tags$a(href="https://github.com/nmfs-stock-synthesis/stock-synthesis", "Stock Synthesis")),
      h4(p(strong("(Formerly known as the Stock Synthesis Data-Limited (SS-DL) tool), this tool uses the Stock Synthesis framework to implement a ",tags$a(href="javascript:window.open('SS-DL-approaches.html', '_blank','width=600,height=400')", "variety of types"), "of models."))),
...
#      tags$ul(tags$li(h5(p(em("If using only length or age data, starting model year is based on earliest year minus age at 95% Linf"))))),
    ...
    h5(p(strong("Additional SS commands can be found ",tags$a(href="javascript:window.open('SS_commands.pdf', '_blank','width=600,height=400')", " here")))),
    ...
    #fluidRow(column(width=10,checkboxInput("advance_ss_click","Advanced SS options",FALSE))),
      ...
      fluidRow(style = "padding-right:50px;padding-left:50px;padding-top:-1000px; padding-bottom:0px;",h6("Software to calculate ageing error matrices from multiple age reads is available ",tags$a(href="https://github.com/pfmc-assessments/nwfscAgeingError", "here"),"(click ctl+left on the link to open the repo).")),
