...
Est.sel.Width<-Model.output$estimated_non_dev_parameters$Value[grep("peak_",rownames(xx$estimated_non_dev_parameters)),]
Est.sel.Final<-Model.output$estimated_non_dev_parameters$Value[grep("peak_",rownames(xx$estimated_non_dev_parameters)),]
