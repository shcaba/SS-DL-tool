...
shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed_est_tog",
  ...
  shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed",
    h4(strong("Life history inputs")),
        ...
        h5("Weight-length relationship W=aL^b. Weight is in kg and length in cm."),
        ...
        h5("Fecundity-length relationship F=aL^b. Fecundity is measured in number of eggs or pups. Set equal to the W-L relationship to get fecundity equivalent to spawning biomass."),
        fluidRow(column(width=6,numericInput("Fec_a_f_fix", "Coefficient a", value=0.00001,min=0, max=10000, step=0.000000001)),
