...
observeEvent(input$run_Profiles,{
       ...
       SS_parm_names<-c(rep.parms.names[rep.parms.names=="SR_BH_steep"], rep.parms.names[rep.parms.names=="SR_LN(R0)"],rep.parms.names[1],rep.parms.names[3],rep.parms.names[4],rep.parms.names[5],rep.parms.names[6],rep.parms.names[13],rep.parms.names[15],rep.parms.names[16],rep.parms.names[17],rep.parms.names[18])
