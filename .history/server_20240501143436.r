...
output$Mplot<-renderPlot({ 
			print(all(!exists("rv.Ct$data"),!exists("rv.Lt$data"),!exists("rv.Age$data"),!exists("rv.Index$data")))
      print(all(is.null(rv.Ct$data),is.null(rv.Lt$data),is.null(rv.Age$data),is.null(rv.Index$data)))
      mf.in = M_f_in()+0.000000000000001 
			mm.in = M_f_in()+0.000000000000001
     print(any(is.na(c(mf.in, mm.in)))|any(is.null(c(mf.in, mm.in)))) 
