...
output$AdvancedSS_plots_RP_inputs<- renderUI({ 
     ...
     # if(input$plot_RPs){
      fluidRow(column(width=4, textInput("plot_RPs_inputs", "Plot target and limit reference points", value="0.4,0.25")))        
     # }
    #} 
  }) 
...
output$AdvancedSS_plots_RP_inputs_user<- renderUI({ 
    ...
    #  if(input$plot_RPs_user){
      fluidRow(column(width=12, textInput("plot_RPs_inputs", "Plot target and limit reference points", value="0.4,0.25")))        
     # }
    #} 
  }) 
