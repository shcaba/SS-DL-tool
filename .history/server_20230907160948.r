...
if(length(grep("peak_",rownames(Model.output$parameters)))>0)
  {
    Est.sel.peak<-Model.output$parameters$Value[grep("peak_",Est.sel.tranformed$Label)]
...
if(length(grep("ascend_",rownames(Model.output$parameters)))>0)
  {
    Est.sel.Sel50<-Model.output$parameters$Value[grep("ascend_",Est.sel.tranformed$Label)]
...
if(length(grep("top_logit",rownames(Model.output$parameters)))>0)
  {
    Est.sel.Decline1<-Model.output$parameters$Value[grep("top_logit",Est.sel.tranformed$Label)]
...
if(length(grep("descend",rownames(Model.output$parameters)))>0)
  {
    Est.sel.Width<-Model.output$parameters$Value[grep("descend",Est.sel.tranformed$Label)]
...
if(length(grep("end_logit",rownames(Model.output$parameters)))>0)
  {
    Est.sel.Final<-Model.output$parameters$Value[grep("end_logit",Est.sel.tranformed$Label)]
