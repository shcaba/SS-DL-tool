...
################################
    ...
    h4(strong("Stock-recruitment parameters")),
   #   wellPanel(
     fluidRow(column(width=6,selectInput("SR_choice_LO","Stock-recruit type",c("Beverton-Holt","Ricker")))),
   ...
   #    ),
    ...
    h4(strong("Stock-recruitment parameters")),
   #   wellPanel(
     fluidRow(column(width=6,selectInput("SR_choice_fixed","Stock-recruit type",c("Beverton-Holt","Ricker")))),
   ...
   #    ),
    ...
    h4(strong("Stock-recruitment parameters")),
     # wellPanel(
       fluidRow(column(width=6,selectInput("SR_choice_est","Stock-recruit type",c("Beverton-Holt","Ricker")))), 
