...
br(),
br(),
h5(strong("Once the model is finished, further model diagnostics are available by loading the fit_model.RData and running launch_shinyadmb(fit_model). This cannot be done while the SS-DL tool is open, so either use another R terminal or close the SS-DL app.")),  
  )),
