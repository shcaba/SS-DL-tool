...
################################
   ...
   #   wellPanel(
     fluidRow(column(width=4,numericInput("h","Steepness", value=0.7,min=0.2, max=1, step=0.01)),
      column(width=4,numericInput("lnR0", "Log initial recruitment (ln(R0))", value=7,min=0.01, max=20, step=0.01))),
      column(width=4,numericInput("rec_month", "Recruitment month", value=7,min=0.01, max=20, step=0.01))),
   #    ),
      )
    ),  
