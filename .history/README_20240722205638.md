...
RStudio is also recommended, as it can make the running of the SAC Tool easier.

I also recommend choosing a text editor. RStudio has a native text editor, but there are many other free text editors.
