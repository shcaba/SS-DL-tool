...
#      tags$ul(tags$li(h5(p(em("If using only length or age data, starting model year is based on earliest year minus age at 95% Linf"))))),
    ...
    #fluidRow(column(width=10,checkboxInput("advance_ss_click","Advanced SS options",FALSE))),
      ...
      br(),
      h5(p("Define plus group age. Default value is based on the female natural mortality value or the maximum age found in the age data file. If this is changed are you are using ages, you will need to update the age data (and ageing error) to match the dimensions expressed here.")),
