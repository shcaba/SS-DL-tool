...
{  
  ...
  output$Ltplot<-renderPlot({ 
      ...
      #  }
       ...
       if(!is.na(Linf())){Lt.dat.plot.Linf$sex[Lt.dat.plot.Linf$sex==0|Lt.dat.plot.Linf$sex==1]<-Linf()}
       if(is.na(Linf())){Lt.dat.plot.Linf$sex[Lt.dat.plot.Linf$sex==0|Lt.dat.plot.Linf$sex==1]<--100}
       if(!is.na(Linf())){Lt.dat.plot.Linf$sex[Lt.dat.plot.Linf$sex==2]<-Linf_m_in()}
       if(is.na(Linf())){Lt.dat.plot.Linf$sex[Lt.dat.plot.Linf$sex==2]<--100}
       Lt.dat.plot.Linf$sex<-factor(Lt.dat.plot.Linf$sex)
       if(!is.na(L50()))Lt.dat.plot.L50$sex[Lt.dat.plot.L50$sex==0|Lt.dat.plot.L50$sex==1]<-L50()
       if(is.na(L50()))Lt.dat.plot.L50$sex[Lt.dat.plot.L50$sex==0|Lt.dat.plot.L50$sex==1]<-(-1)
       Lt.dat.plot.L50$sex[Lt.dat.plot.L50$sex==2]<-(-1)
       Lt.dat.plot.L50$sex<-factor(Lt.dat.plot.L50$sex)
        ...
        #geom_col(position="dodge") + 
		    geom_vline(data=na.omit(Lt.dat.plot.L50),
                    aes(xintercept = sex),
                    linetype="dashed",
                    colour = "darkgreen",
                    na.rm = TRUE,
                    show.legend = TRUE)+
        geom_vline(data=na.omit(Lt.dat.plot.Linf),
                    aes(xintercept = sex),
                    colour = "#d26678",
                    na.rm = TRUE,
                    show.legend = TRUE)+
