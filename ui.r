 ...
 fluidRow(column(width=12,fileInput('file2', 'Catch time series',
  ...
  h4(strong("Clear data files")),
    ...
    h4(strong("Life history inputs")),
        ...
        fluidRow(column(width=6,numericInput("Fec_a", "t-Fecundity: a in F=aL^b", value=0.00001,min=0, max=10000, step=-0.01)),
                column(width=6,numericInput("Fec_b","t-Fecundity: b in F=aL^b", value=3,min=0, max=10000, step=0.01))),    
       ),
