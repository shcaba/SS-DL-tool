...
ui <- function(request) {
  shinyUI(fluidPage(
    ...
    h4(p(strong(
      ...
      tags$a(
        href = "javascript:window.open('SS-DL-approaches.html', '_blank','width=600,height=400')",
        "variety of types"
      ),
      "of models."
    ))),
    h5(p(
      "Any suggested changes or requests? Please submit an issue with the recommendation",
      tags$a(
        href = "https://github.com/shcaba/SS-DL-tool/issues",
        "here",
        target = "_blank"
      )
    )),
    h5(p(
      "Access the latest version of the Stock Synthesis manual ",
      tags$a(
        href = "https://nmfs-ost.github.io/ss3-doc/",
        "here",
        target = "_blank"
      )
    )),
    h5(p(
      "Watch a talk on how to use the SAC tool and the concept of the stock assessment continuum ",
      tags$a(
        href = "https://www.youtube.com/watch?v=NFJPoFJ9qyo",
        "here",
        target = "_blank"
      )
    )),
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(
            ...
            column(
              12,
              h6(
                "File names should only include letters and numbers, otherwise an upload error may occur. If you see 'Error: Invalid state id', rename the file and try again."
              )
            )
          )
        )),
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(column(
            ...
            fileInput(
              'file33',
              span(
                'Optional ageing error file. No file assumes age data are unbiased and precise. Software to calculate ageing error matrices from multiple age reads is available ',
                tags$a(
                  href = "https://github.com/pfmc-assessments/nwfscAgeingError",
                  "here",
                  target = "_blank"
                ),
                ". A",
                tags$a(
                  href = "https://github.com/shcaba/Ageing_Error_app",
                  "Shiny app",
                  target = "_blank"
                ),
                " is also available to access the multiple versions of this software"
              ),
              accept = c(
                'text/csv',
                'text/comma-separated-values',
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(column(
            width = 10,
            checkboxInput("user_model", "Use existing model files?", FALSE)
          )),
          h5(em("Do not use this option with catch only models.")),
          h5(em(
            "Make sure the model run is in the Scenarios folder. Put that folder name in the Scenario name input and run the model."
          )),
          h5(em(
            "Using an existing model allows you to do run complex and custom model runs outside the options of the SS-DL tool, but still use some of the quick features."
          )),
          h5(em(
            "Examples are applying jitters or any of the additional SS3 options that do not modify the data or control files."
          )),
          h5(em(
            "To do sensitivity runs for pre-existing models, make a copy of the folder and re-name it, then make desired changes in the data and/or control files."
          )),
        )),
        shinyjs::hidden(wellPanel(
          id = "panel_Ct_F_LO",
          ...
          h5(em(
            "This approach is a more variable reponse to estimating stock status, and is best used with continuous years of contemporary data. Recruitment can also be estimated."
          )),
        ...
        shinyjs::hidden(wellPanel(
          ...
          h5(em(
            "Catches data file assume 0 equilibrium catch. Enter equilibrium catch for each fleet separated by a comma."
          )),
          h5(em(
            "This approach can also be used to determine a specific stock status from which to start the entered catch time series."
          )),
          h5(em(
            "It may take trial and error of different equilibrium catches to achieve the desired entry stock status."
          )),
        ...
        shinyjs::hidden(wellPanel(
          ...
          h4(strong(em("Male"))),
          h5(
            "Enter male specific values. Otherwise, males are assumed equal to females"
          ),
          h5(
            "If estimating any female life history parameters and you want males to equal the estimated females values, you have two options. 1) Set the male initial and SD values to 0 and the prior to 'no prior' or 2) use the offset option and pre-specify the male parameter(s) to 0 to ensure males = females. If you don't do either of these, the males values will remain at the female starting values."
          ),
          fluidRow(
            column(
              width = 6,
              div(
                checkboxInput("male_parms", "Males specific values?", FALSE),
            ...
            column(
              ...
              checkboxInput(
                "male_offset",
                "Males offset from females (log(m/f))?",
                FALSE
              )
            )
          ),
        ...
        shinyjs::hidden(wellPanel(
          ...
          h5(
            "Parameters can either be pre-specified (i.e., set to specific value) or estimated."
          ),
          h5(
            "Estimating parameters is a data-based approach to determining life history values"
          ),
          h5(
            "Estimating parameters can also propagate parameter uncertainty into derived model outputs"
          ),
          br(),
          h5(
            "When estimating parameters with catch and length (SS-CL) models consider:"
          ),
          tags$ul(tags$li(h5(p(
            "It is recommended to run the model first by pre-specifying parameters."
          )))),
          tags$ul(tags$li(h5(p(
            "Then run likelihood profiles to see if the data contain any information on parameters."
          )))),
          tags$ul(tags$li(h5(p(
            "Parameters that seem informed by the data (i.e., result in realistic values) are good candidates for estimation."
          )))),
          tags$ul(tags$li(h5(p(
            "The most likely parameters to have information from fishery-based lengths are Linf and M."
          )))),
          h5(
            "Not all parameters need be estimated. Fix parameters by turning the phase negative (e.g., -1)."
          ),
          h5(
            "The concept of phasing allows the user to say when to start parameter estimate, thus spreading out parameter estimation instead of doing all estimation at once. For example, parameters in phase 1 will begin estimation immediately. Parameters in phase 2 will stay at their input value until phase 1 estimation is complete. All parameters in any earlier phases continue to be re-estimated in subsequent phases. Have questions on what phase to put parameters? Click",
            tags$a(
              href = "javascript:window.open('Phasing_AEP.pdf', '_blank','width=600,height=400')",
              "here"
            ),
            "for some suggestions."
          ),
          h5(p(
            "Natural mortality is an often difficult value to obtain. Consider using",
            tags$a(
              href = "https://connect.fisheries.noaa.gov/natural-mortality-tool/",
              "The Natural Mortality Tool",
              target = "_blank"
            ),
            " to either obtain natural mortality values or developing a prior for use in estimating natural mortality. The Github repository for it can be found",
            tags$a(
              href = "https://github.com/shcaba/Natural-Mortality-Tool",
              "here",
              target = "_blank"
            ),
            "."
        ...
        shinyjs::hidden(wellPanel(
          ...
          wellPanel(
            id = "panel_SS_fixed_ltwtfec",
            h5(
              "Length-weight relationship W=aL^b. Weight is in kg and length in cm."
            ),
            fluidRow(
              column(
                width = 6,
            ...
            h5(
              "Length-fecundity relationship F=aL^b. Fecundity is measured in number of eggs or pups. Set equal to the length-weight relationship to get fecundity equivalent to spawning biomass."
            ),
            fluidRow(
              column(
                width = 6,
          ...
          h5(em(
            "If estimating females and wanting to match males to estimated female parameters, use the male offset option and set offsets to 0. This will ensure male values are equal to estimated female males. Otherwise, males will retain the initial female values."
          )),
          fluidRow(
            column(
              width = 6,
              checkboxInput("male_parms_fix", "Males specific values?", FALSE)
            ),
            column(
              width = 6,
              checkboxInput(
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(
            column(
              width = 6,
              checkboxInput("male_parms_est", "Males specific values?", FALSE)
            ),
            column(
              width = 6,
              checkboxInput(
        ...
        shinyjs::hidden(wellPanel(
          ...
          h4(strong("Life history inputs")),
          h5(em(
            "If using the uniform prior, low and high range go in the mean and SD input, respectively."
          )),
          wellPanel(
            h4(em("Female")),
            h5(strong("Natural mortality")),
            ...
            dropdownButton(
              selectInput(
                "CV_lt_f_young_prior_sss",
                "Prior type for CV_lt young",
                c("no prior")
              ),
              numericInput(
                "CV_lt_f_young_mean_sss",
                "Mean",
                value = 0.1,
                min = 0,
                max = 10000,
            ...
            dropdownButton(
              selectInput(
                "CV_lt_f_old_prior_sss",
                "Prior type for CV_lt old",
                c("no prior")
              ),
              numericInput(
                "CV_lt_f_old_mean_sss",
                "Mean",
                value = 0.1,
                min = 0,
                max = 10000,
          ...
          fluidRow(
            column(
              width = 10,
              checkboxInput("male_parms_SSS", "Males specific values?", FALSE)
            ),
            column(
              width = 10,
              checkboxInput(
                "male_offset_SSS",
                "Males offset to females (log(m/f)?",
                FALSE
              )
            )
          ),
        ...
        shinyjs::hidden(wellPanel(
          ...
          dropdownButton(
            selectInput(
              "Depl_prior_sss",
              "Prior type for relative stock status",
              c("beta", "lognormal", "truncated normal", "uniform", "no prior")
            ),
            numericInput(
              "Depl_mean_sss",
              "Mean",
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(column(
            ...
            selectInput(
              "SR_choice_LO",
              "Stock-recruit type",
              c("Beverton-Holt", "Ricker", "B-H flat-top")
            )
          )),
          fluidRow(
            column(
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(column(
            width = 10,
            checkboxInput("rec_choice", "Estimate recruitment?", FALSE)
          )),
          wellPanel(
      ...
      input[type='checkbox']{ /* style for checkboxes */
        ...
        #   line-height: 30px;
            ...
            fluidRow(column(
              width = 10,
              checkboxInput("biasC_choice", "Bias correct recruitments?", FALSE)
            )),
        ...
        # Selectivity
        shinyjs::hidden(wellPanel(
          id = "panel_selectivity_sss",
          #   wellPanel(
          h4(strong("Selectivity")),
          h5("Enter parameter values for each fleet and survey."),
          h5(
            "Example using 50% selectivity with two fleets: Inputs could be 35,40 for starting values."
          ),
          p(
            "If using a mix of logistic and dome-shaped selectivities, select",
            strong("dome-shaped"),
            "and use the default values (10000,0.0001,0.9999 for the additional parameters, respectively) to achieve a logistic shape for any given fleet."
          ),
          br(),
          fluidRow(selectInput(
            "Sel_choice_sss",
            "Length selectivity type",
            c("Logistic", "Dome-shaped")
          )),
        ...
        shinyjs::hidden(wellPanel(
          ...
          h5(
            "The phase input indicates estimated parameters. To pre-specify the parameter, set the phase value to a negative number."
          ),
          p(
            "If using a mix of logistic and dome-shaped selectivities, select",
            strong("dome-shaped"),
            "and pre-specify (i.e., use a negative phase) the provided default values (10000,0.0001,0.9999 for the additional parameters, respectively) to achieve a logistic shape for any given fleet."
          ),
          br(),
          fluidRow(selectInput(
            "Sel_choice",
          ...
          # fluidRow(column(width=6,numericInput("Selpeak", "Length at Peak Selectivity", value=NA,min=0, max=10000, step=0.01)),
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(column(
            width = 10,
            checkboxInput("jitter_choice", "Jitter starting values?", FALSE)
          )),
          uiOutput("Jitter_value"),
          h5("Jittering refers to changing the input starting values."),
          h5(
            "Jittering provides a quick way to adjust starting values for two main purposes:"
          ),
          tags$ul(tags$li(h5(p(
            "Start the model at different values to assist model convergence."
          )))),
          tags$ul(tags$li(h5(p(
            "Validate global versus local model convergence. This requires running many models at different jittered starting values to make sure a lower minimized likelihood value is not found. If a lower likelihood value is found, that would be considered the best fit model."
          )))),
          h5(
            "Run just 1 jitter value to find a converged model. Then run multiple jittered models to confirm that model is the best fit model."
          ),
          fluidRow(column(
            width = 10,
            checkboxInput("jitter_parallel", "Run jitters in parallel?", FALSE)
          )),
          h5(
            "Runs jitters in parallel. Works well if running many jitters. It can run if your machine has only a couple cores, but works best if you have access to a machine or virtual machine with more cores."
          ),
          h5(
            "See ",
            a(
              "r4ss::jitter()",
              href = "https://github.com/r4ss/r4ss/blob/main/R/jitter.R",
              target = "_blank"
            ),
            " for more information or type `?r4ss::jitter()` in your R console"
          )
        )),
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(column(
            width = 10,
            checkboxInput("RP_choices", "Define reference points?", FALSE)
          )),
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(column(
            width = 10,
            checkboxInput("Forecast_choice", "Define forecasts?", FALSE)
          )),
          uiOutput("Forecasts")
        )),
        shinyjs::hidden(wellPanel(
        ...
        shinyjs::hidden(wellPanel(
          id = "panel_advanced_SS",
          h4(strong("Additional SS3 options")),
          h5(p(strong(
            "Additional SS3 commands can be found ",
            tags$a(
              href = "javascript:window.open('SS_commands.pdf', '_blank','width=600,height=400')",
              " here"
            )
          ))),
          ...
          popify(
            ...
            "Run -nohess option",
            "Turning off the Hessian option skips over asymptotic variance and speeds the model up. Use this option to more quickly explore models. Estimate variance once you are done exploring."
          ),
          popify(
            uiOutput("AdvancedSS_addcomms"),
            "Custom SS3 run commands",
            "Click the advanced SS3 commands link above to get options. One interesting option is -hess_step which attempts to make the model gradient 0. This should be run once a final model is found."
          ),
          popify(
          ...
          fluidRow(
            ...
            column(
              width = 8,
              popify(
                uiOutput("AdvancedSS_plots_RP_inputs"),
                "Relative Stock Size target and limit reference points",
                "Enter a value between 0 and 1 for both."
              )
            )
          ),
          popify(
            uiOutput("AdvancedSS_noestabs"),
            "No Executive Summary tables",
            "Executive Summary tables take time to make, but provide summary tables of the model. When exploring models, it is better to turn this off to speed up the model run."
          ),
          ...
          popify(
            ...
            "Maximum phase = 0",
            "Setting maximum phase to 0 turns off all parameter estimation and is useful when forecasting catch into the future. Couple with using the ss.par file (see above option)."
          ),
          ...
          popify(
            ...
            "Catch units",
            "The default assumption is that catch is in metric tons (option 1), but if they are in numbers, option 2 should be used."
          ),
          popify(
            uiOutput("AdvancedSS_Ctunitsfleets"),
            "Enter units",
            "1=biomass; 2=numbers. Enter one of these numbers for each removal fleet."
          ),
          popify(
            uiOutput("AdvancedSS_GT1"),
            "Growth morphs",
            "Stock Synthesis can track multiple growth morphs distributed around a central morph. The default here is tracking 5 morphs, but using only 1 is also common. This switch moves from 5 to 1 morph."
          ),
          popify(
            uiOutput("AdvancedSS_Indexvar"),
            "Added index variance.",
            "The input index variance is often underestimated. This option allows more variance to be added to each index in order to improve model fit. This is a type of weighting option for indices. The added variance is the same for each year of a particular index, but can be different across indices. Beware large index outliers that may overinflate added variances in order to get the model to fit that one data point."
          ),
          popify(
            uiOutput("AdvancedSS_Sex3options"),
            "Sex=3 option for biological compositions",
            "This switch changes the per sex biological compositions (sex = 1 for females and 2 for males) into a two sex length composition that retains the overall biological composition of the sample. This may add additional information on the underlying sex ratio of the population, but should be tested against using the biological compositions by sex. Choose to apply this method to lengths and/or ages."
          ),
          fluidRow(
            column(width = 6, uiOutput("AdvancedSS_Sex3")),
          ...
          h5(
            "Default values are by 2 cm bin ranging from 4 to 25% above the Linf value. If using conditional age at lengths, length bins must be consistent with these population bins, not the length data bins."
          ),
          h5(p(em(
            "Inputs must be smaller and larger than the length composition bins. Input values will be overridden to meet this requirement"
          ))),
          uiOutput("AdvancedSS_Ltbin"),
          br(),
          h5(strong(p("Define plus group age"))),
          h5(
            "Default value is based on the female natural mortality value or the maximum age found in the age data file."
          ),
          h5(p(em(
            "If you change this value here AND you are using age data, you will need to update the age data (and ageing error) to match the dimensions expressed here."
          ))),
        ...
        shinyjs::hidden(wellPanel(
          ...
          popify(
            ...
            "Switch to use the ss.par file",
            "The ss.par file contains all parameter values used in the previous model run. It can be handy to run models from the par file to confirm you have reached the best fit model. The par file can also be used to expedite forecasts by turning the maximum phase to zero (see next option) and using the par file."
          ),
          popify(
          ...
          popify(
            ...
            "Switch starter file to use the data_echo.ss_new file.",
            "This file is a copy of the data file used in the last run. It has additional notes for inputs, and can be modified to run new scenarios, if desired."
          ),
          popify(
            uiOutput("AdvancedSS_controlnew_user"),
            "Switch starter file to use the control.ss_new file.",
            "This file is a copy of the control file used in the previous run, but starting values are the ending values of the previous model. Like the ss.par file, it can be used to run from where the last model finished, but also provides a convenient way to change other parameter specifications."
          ),
          popify(
            uiOutput("AdvancedSS_forecastnew_user"),
            "Overwrite the forecast.ss file with the forecast.ss_new file.",
            "This file is a copy of the forecast file used in the previous run. In the event you want to use this file, this switch will overwrite the forecast file content with what is in the forecast.ss_new."
          ),
          # uiOutput("AdvancedSS_retro_choice_user"),
          # uiOutput("AdvancedSS_retro_years_user")
        )),
        shinyjs::hidden(wellPanel(
          id = "panel_advanced_SSS",
          h4(strong("Additional SS3 options")),
          h5(strong("Choosing catch units")),
          h6(strong(
            "Default is biomass (in MT), but click below button to specify for each fleet."
          )),
          # fluidRow(column(width=10,checkboxInput("advance_ss_click","Advanced SS3 options",FALSE))),
        ...
        shinyjs::hidden(wellPanel(
          ...
          fluidRow(column(
            ...
            textInput(
              "Scenario_name",
              strong("Choose the name of your scenario"),
              value = "Scenario_1"
            )
          )),
          h5(p(em(
            "Each scenario folder is saved. Changing the scenario name therefore creates a new folder of results."
          ))),
          h5(p(em(
            "Using different scenario names when changing data or parameter values allows easy sensitivity exploration."
          ))),
          h5(p(strong(
            "For Mac and Linux users, do not leave spaces in the Scenario name."
          ))),
          ...
          fluidRow(column(
            ...
            checkboxInput(
              ...
              h5(strong("Add a scenario description?")),
              FALSE
            )
          )),
        ...
        shinyjs::hidden(wellPanel(
          ...
          h5(em(
            "Using ",
            tags$a(
              href = "https://github.com/Cole-Monnahan-NOAA/adnuts",
              "AD NUTS",
              target = "_blank"
            ),
          ...
          tags$ul(tags$li(h5(p(em(
            "Random walk Metropolis (RWM). This method is useful to quickly explore parameter behavior."
          ))))),
          tags$ul(tags$li(h5(p(em(
            "No u-turn (Nuts). This method can quickly run Bayesian models once an efficient model is established. No thinning necessary, as that is part of the algorithm"
          ))))),
          h5(
            ("The following is a recommended work flow to find and run an efficient Bayesian model:")
          ),
          tags$ul(tags$li(h5(p(em(
            "Optimize you model with a short Bayesian run. Click the 'optimize model' button."
          ))))),
          tags$ul(tags$li(h5(p(em(
            "Run your optimized model using RWM with 2000 iterations and thin = 10, then use the pairs plots to look for parameters that don't change value across kept draws."
          ))))),
          tags$ul(tags$li(h5(p(em(
            "Evaluate the produced pairs plots to look for parameters that don't change value across kept draws."
          ))))),
          tags$ul(tags$li(h5(p(em(
            "Parameters that don't move should be pre-specified in the model, and the model re-optimized."
          ))))),
          tags$ul(tags$li(h5(p(em(
            "Run the RWM model again and continue looking for and pre-specifying any non-moving parameters."
          ))))),
          br(),
          h5(("Once the model specification is finalized, you can")),
          tags$ul(tags$li(h5(p(em(
            "Re-run with Hessian (go back to the first tab to re-run model) to get asymptotic variance estimates. "
          ))))),
          tags$ul(tags$li(h5(p(em(
            "Re-optimize, then consider using the NUTS option with 1000 iterations or keep running the RWM option until convergence criteria are reached by increasing the thinning value and/or number of iterations. This produces a Bayesian representation of uncertainty."
          ))))),
          br(),
          h5(("Good model convergence is indicated when:")),
          tags$ul(tags$li(h5(p(em(
            "Minimum effective sample size (ESS) > 200"
          ))))),
          tags$ul(tags$li(h5(p(em(
            "Rhat < 1.1, This measures the ratio of overestimated to underestimated variance."
          ))))),
          awesomeCheckbox(
            inputId = "Opt_mod",
          ...
          h5(
            ("One should include model optimization before running the evaluation methods below if this is the first run of a given model specification, including if parameters have been pre-specified since the last exploration.")
          ),
          br(),
          ...
          fluidRow(
            ...
            column(
              ...
              numericInput(
                "thin",
                "Thinning (RWM only): # of iterations to keep?",
                value = 10,
                min = 1,
                max = 1000000000,
                step = 10
          ...
          br(),
          h5(strong(
            "Once the model is finished, further model diagnostics are available by loading the fit_model.RData object created (use the load() function in R) and running launch_shinyadmb(fit_model)."
          )),
          h5(strong(
            "This cannot be done while the SS-DL tool is open, so either use another R terminal or close the SS-DL app."
          )),
        )),
        ...
        shinyjs::hidden(wellPanel(
          ...
          h5(em(
            "A likelihood profile pre-specifies a chosen parameter to a specified set of values in a reference model. The reference model will maintain estimation of any other parameters estimated in the reference model."
          )),
          h5(em(
            "For example, natural mortality (M) could be profiled over the value 0.1 to 0.3 at steps of 0.01. This creates 21 model runs that pre-specify M to different values while keeping all other specifications the same as the reference model."
          )),
          h5(em(
          ...
          br(),
          h4(
            ("Individual likelihood profiles- each parameter run independently.")
          ),
          h5(em(
            "If choosing multiple parameters to individually profile over, entries should be done in order of the parameters shown and separated by a comma (e.g., 0.1, 0.3)."
          )),
          h5(em(
            "The range of values must also include the value of the model being used. If not, the profile will not run."
          )),
          ...
          fluidRow(
            column(
              width = 4,
              textInput("Prof_Low_val", "Low value", value = "")
            ),
            column(
              width = 4,
              textInput("Prof_Hi_val", "High value", value = "")
            ),
            column(
              width = 4,
          ...
          h5(em(
            "For example, Linf and k are negatively correlated and should be changing together in a profile."
          )),
          h5(em(
            "Read in .csv file with vectors of values for each parameter."
          )),
          h5(em(
            "See the 'Multi_profile_headers.csv' file for parameter header names. Erase columns not used and fill in rows with values for each likelihood run."
          )),
          ...
          actionButton(
            "run_MultiProfiles",
            strong("Run Likelihood Multi-Profile"),
            width = "100%",
            icon("circle-play"),
            style = "font-size:120%;border:2px solid;color:#FFFFFF; background:#236192"
          ),
        ...
        shinyjs::hidden(wellPanel(
          ...
          h5(em(
            "Retrospective modelling means sequentially removing one year of data up to a specified number of years (e.g., -10 years)."
          )),
          h5(em(
            "To make these comparisons, choose first the directory containing models, then the models to compare."
          )),
          h5(em(
            "A time series plot of comparisons are shown in the main panel to the right for the following model outputs:"
          )),
          ...
          h5(em(
            "A complete compliment of comparison plots (along with the plot on the right) are saved in the chosen folder labeled 'retro'"
          )),
          # h5(strong(em("Retrospective Comparison Plots"))),
          br(),
          h5(strong(
            "Choose folder containing model for retrospective analysis"
          )),
          shinyDirButton(
            id = "Retro_dir",
            label = "Select folder",
          ...
          h5(strong(
            "Define what years to perform retrospective analysis. Input as a negative integer (e.g., -1 mean remove one year of data)"
          )),
          fluidRow(
            column(
              width = 6,
          ...
          actionButton(
            "run_Retro_comps",
            strong("Run Retrospective Comparisons"),
            width = "100%",
            icon("circle-play"),
            style = "font-size:120%;border:2px solid;color:#FFFFFF; background:#236192"
          ),
        ...
        shinyjs::hidden(wellPanel(
          ...
          tags$ul(tags$li(h5(p(em("Recruitment"))))),
          h5(em(
            "A complete compliment of comparison plots (along with the plot on the right) are saved in the chosen directory in a folder labeled"
          )),
          ...
          h5(strong(
            "Add y-axis limits, vertical subheader breaks, sensitivity group subheaders, text size and positioning"
          )),
          fluidRow(
            column(
              width = 6,
          ...
          fluidRow(column(
            ...
            textInput(
              "SensiRE_breaks",
              strong("Subheader vertical break positions"),
              value = " "
            )
          )),
          fluidRow(
          ...
          fluidRow(
            column(
              ...
              textInput(
                "SensiRE_xcenter",
                strong("Vertical (x) centering of headers"),
                value = " "
              )
            ),
            column(
              ...
              textInput(
                "SensiRE_ycenter",
                strong("Horizontal (y) centering of headers"),
                value = " "
              )
            )
          ),
          fluidRow(column(
            ...
            textInput(
              "Sensi_comp_file",
              strong("Comparison plot folder name"),
              value = "Comparison 1"
            )
          )),
          # br(),
          ...
          actionButton(
            "run_Sensi_comps",
            strong("Run Sensitivity Comparisons"),
            width = "100%",
            icon("circle-play"),
            style = "font-size:120%;border:2px solid;color:#FFFFFF; background:#236192"
          ),
        ...
        shinyjs::hidden(wellPanel(
          ...
          h5(em(
            "Ensemble modelling allows the user to combine multiple models into one weighted distribution of outputs."
          )),
          h5(em(
            "User first chooses the models to combine, then how to combine them via model weights."
          )),
          h5(em(
            "For example, if 3 models are chosen, weights of 1,1,1 defines equal weights."
          )),
          h5(em(
            "If the middle model should have twice the weight of the others, 1,2,1 is the weighting input."
          )),
          br(),
          ...
          fluidRow(column(
            ...
            textInput(
              "Ensemble_file",
              strong("Label ensemble model file"),
              value = "Ensemble 1"
            )
          )),
      ...
      mainPanel(
        tabsetPanel(
          ...
          tabPanel(
            ...
            tags$head(tags$style(
              "#lt_comp_plots_label{color: black;
                                 font-size: 16px;
                                 }"
            )),
            uiOutput("Ltplot_it"),
            ...
            tags$head(tags$style(
              "#marginal_age_comp_plots_label{color: black;
                                 font-size: 16px;
                                 }"
            )),
            ...
            tags$head(tags$style(
              "#conditional_age_comp_plots_label{color: black;
                                 font-size: 16px;
                                 }"
            )),
            ...
            tags$head(tags$style(
              "#lt_comp_sel_plots_label{color: black;
                                 font-size: 16px;
                                 }"
            )),
          ...
          tabPanel(
            "SSS Model output",
            h4(
              "Full model output is contained in the SSS_out.rds and SSSoutput.rds files in the specific model scenario folder."
            ),
            h5(
              "The SSS_out.rds contains the prior and posterior values from the model, as well as the catch limits (Overfishing limint (OFL) and Allowable Biological Catch (ABC))."
            ),
            h5(
              "The SSSoutput.rds contains a list of the complete report files for each SSS run."
            ),
            br(),
          ...
          tabPanel(
            "Model output",
            h4(
              "Full model output is contained in the Report.sso file. The following reports are meant for quick examination."
            ),
            h4(
              "Checking model convergence. Check also fit to length composition data"
            ),
            tableOutput("converge.grad"),
            tableOutput("converge.covar"),
            tableOutput("converge.dec"),
            tags$head(tags$style(
              "#converge.grad{color: black;
                                 font-size: 20px;
                                 font-style: italic;
                                 }"
            )),
            tags$head(tags$style(
              "#converge.dec{color: green;
                                 font-size: 20px;
                                 font-style: italic;
                                 }"
            )),
          ...
          tabPanel(
            ...
            h4(
              "Blue values indicate minimum likelihood values; red indicate values higher than the minimum."
            ),
            h4(
              "Any iteration with a blue value can be used as the new best-fit (reference) model."
            ),
            plotOutput("Jittercompplot1"),
            h4(
              "Comparison of spawning output among jittered models. Model 0 is the initial model; numbered models are the sequential jittered models."
            ),
            plotOutput("Jittercompplot2"),
            h4(
              "Comparison of relative stock status among jittered models. Model 0 is the initial model; numbered models are the sequential jittered models."
            ),
            value = 3
          ),
          tabPanel(
            "Likelihood profile",
            h4(
              "Full likelihood profile outputs and plots can be found in the 'Profile' folder of the chosen scenario."
            ),
            h5(
              "Each profile folder will be labeled with the parameter name appended."
            ),
            h5(
              "Results below are from the one of the profile parameters to show what type of plots are found in the folders."
            ),
            ...
            br(),
            h5(
              "Multiple likelihood profile plot. Blue dot indicates reference model"
            ),
          ...
          tabPanel(
            ...
            headerPanel(""),
            h4(
              "Relative change (Scenario relative to reference model) sensitivity plots for 5 different metrics"
            ),
            h5(
              "Unfished spawning output and terminal year spawning output measure scale"
            ),
            h5("Relative biomass is a stock status measure"),
            h5(
              "FMSY is a measure of productivity; MSY is a measure of productivity and scale"
            ),
            h5(
              paste(
                "For more details on interpreting these plots, please see "
              ),
              tags$a(
                "Cope and Gertseva 2020",
                target = "_blank",
                href = "CopeandGertseva2020.pdf"
              )
            ),
            ...
            headerPanel(""),
            h4(
              "Log relative change (scenario relative to reference model) sensitivity plots for 5 different metrics"
            ),
            h5(
              "Log relative change addresses the assymetry in possible relative change (infinity at the highest and 0 at the lowest)."
            ),
