 ...
 fluidRow(column(width=12,fileInput('file2', 'Catch time series',
  ...
  h4(strong("Clear data files")),
    ...
    h4(strong("Life history inputs")),
        ...
        fluidRow(column(width=6,numericInput("Fec_a", "t-Fecundity: a in F=aL^b", value=1,min=0, max=10000, step=-0.01)),
                column(width=6,numericInput("Fec_b","t-Fecundity: b in F=aL^b", value=1,min=0, max=10000, step=0.01))),    
       ),
...
shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed_est_tog",
  ...
  shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed",
    h4(strong("Life history inputs")),
        ...
        fluidRow(column(width=6,numericInput("Fec_a_fix", "Lt-Fecundity: a in F=aL^b", value=1,min=0, max=10000, step=-0.01)),
                column(width=6,numericInput("Fec_b_fix","Lt-Fecundity: b in F=aL^b", value=1,min=0, max=10000, step=0.01))),    
       ),
...
#      fluidRow(column(width=10,switchInput("est_parms2","Estimate parameters?",value=TRUE))),      
    ...
    h5(strong("Maturity and weight-length relationships")),            
      ...
      fluidRow(column(width=6,numericInput("Fec_a_est", "Lt-Fecundity: a in F=aL^b", value=1,min=0, max=10000, step=-0.01)),
              column(width=6,numericInput("Fec_b_est","Lt-Fecundity: b in F=aL^b", value=1,min=0, max=10000, step=0.01))),    
   ...
   #  ),
    ...
    h5(strong("Maturity and weight-length relationships")),            
      ...
      fluidRow(column(width=6,numericInput("Fec_a_sss", "Lt-Fecundity: a in F=aL^b", value=1,min=0, max=10000, step=-0.01)),
              column(width=6,numericInput("Fec_b_sss","Lt-Fecundity: b in F=aL^b", value=1,min=0, max=10000, step=0.01))),    
