...
###############################
  shinyjs::hidden(wellPanel(id="Sensi_Comparison_panel",
    ...
    fluidRow(column(width=6,numericInput("SensiRE_ymin", "Vertical (x) centering of headers", value=-1,min=-100, max=100, step=0.01)),
                column(width=6,numericInput("SensiRE_ymax","Horizontal (y) centering of headers", value=1,min=-100, max=100, step=0.01 ))),    
