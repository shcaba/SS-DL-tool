...
shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed_est_tog",
  ...
  shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed",
    h4(strong("Life history inputs")),
        ...
        fluidRow(column(width=6,numericInput("WLa_f_fix", "Weight (kg)-Length (cm) alpha", value=0.00001,min=0, max=10000, step=0.000000001)),
                column(width=6,numericInput("WLb_f_fix","Weight (kg)-Length (cm) beta", value=3,min=0, max=10000, step=0.01))),    
...
#      fluidRow(column(width=10,switchInput("est_parms2","Estimate parameters?",value=TRUE))),      
    ...
    h5(strong("Maturity and weight-length relationships")),            
      ...
      fluidRow(column(width=6,numericInput("WLa_f_est", "Weight (kg)-Length (cm) alpha", value=0.00001,min=0, max=10000, step=0.000000001)),
              column(width=6,numericInput("WLb_f_est","Weight (kg)-Length (cm) beta", value=3,min=0, max=10000, step=0.01))),    
    ),
   ...
   #  ),
    ...
    h5(strong("Maturity and weight-length relationships")),            
      ...
      fluidRow(column(width=6,numericInput("WLa_f_sss", "Weight (kg)-Length (cm) alpha", value=0.00001,min=0, max=10000, step=0.000000001)),
              column(width=6,numericInput("WLb_f_sss","Weight (kg)-Length (cm) beta", value=3,min=0, max=10000, step=0.01))),    
    ),
