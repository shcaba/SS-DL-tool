...
###############################
  shinyjs::hidden(wellPanel(id="Sensi_Comparison_panel",
    ...
    fluidRow(column(width=8,textInput("SensiRE_breaks", strong("Position of vertical breaks"), value=NA))),
    fluidRow(column(width=8,textInput("SensiRE_headers", strong("Headers for relative error plots"), value=NA))),
    fluidRow(column(width=6,textInput("SensiRE_xcenter", "Vertical (x) centering of headers", value=NA)),
                column(width=6,textInput("SensiRE_ycenter","Horizontal (y) centering of headers", value=NA))),    
    #br(),
    #br(),
...
#         navbarPage(id="tabs",
          ...
          tabPanel("Sensitivities",
            ...
            h5("For more details on interpreting these plots, please see Cope and Gertseva 2020."), 
