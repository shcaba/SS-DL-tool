...
#      fluidRow(column(width=10,switchInput("est_parms2","Estimate parameters?",value=TRUE))),      
      ...
      fluidRow(column(width=4,style='padding:1px;',align="center", selectInput("M_prior","Prior type",c("no prior","symmetric beta", "beta","lognormal","gamma","normal"))),
      ...
      h5(strong("Growth")),            
      h5(strong("Linf")),            
      fluidRow(column(width=4,style='padding:1px;',align="center",selectInput("Linf_f_prior","Prior type",c("no prior","symmetric beta", "beta","lognormal","gamma","normal"))),
     ...
     h5(strong("k")),            
      fluidRow(column(width=4,style='padding:2px;',selectInput("k_f_prior","Prior type",c("no prior","symmetric beta", "beta","lognormal","gamma","normal"))),
     ...
     h5(strong("t0")),            
      fluidRow(column(width=4,style='padding:2px;',selectInput("t0_f_prior","Prior type",c("no prior","symmetric beta", "beta","lognormal","gamma","normal"))),
     ...
     h5(strong("Length CV")),            
      fluidRow(column(width=4,style='padding:2px;',selectInput("CV_f_prior","Prior type",c("no prior","symmetric beta", "beta","lognormal","gamma","normal"))),
