 ...
 fluidRow(column(width=12,fileInput('file2', 'Catch time series',
  ...
  h4(strong("Clear data files")),
    ...
    h4(strong("Life history inputs")),
        ...
        fluidRow(column(width=6,numericInput("Fec_a_f", "t-Fecundity: a in F=aL^b", value=0.00001,min=0, max=10000, step=-0.01)),
                column(width=6,numericInput("Fec_b_f","t-Fecundity: b in F=aL^b", value=3,min=0, max=10000, step=0.01))),    
       ),
...
shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed_est_tog",
  ...
  shinyjs::hidden(wellPanel(id="panel_SS_LH_fixed",
    h4(strong("Life history inputs")),
        ...
        fluidRow(column(width=6,numericInput("Fec_a_f_fix", "Lt-Fecundity: a in F=aL^b", value=0.00001,min=0, max=10000, step=-0.01)),
                column(width=6,numericInput("Fec_b_f_fix","Lt-Fecundity: b in F=aL^b", value=3,min=0, max=10000, step=0.01))),    
       ),
...
#      fluidRow(column(width=10,switchInput("est_parms2","Estimate parameters?",value=TRUE))),      
    ...
    h5(strong("Maturity and weight-length relationships")),            
      ...
      fluidRow(column(width=6,numericInput("Fec_a_f_est", "Lt-Fecundity: a in F=aL^b", value=0.00001,min=0, max=10000, step=-0.01)),
              column(width=6,numericInput("Fec_b_f_est","Lt-Fecundity: b in F=aL^b", value=3,min=0, max=10000, step=0.01))),    
   ...
   #  ),
    ...
    h5(strong("Maturity and weight-length relationships")),            
      ...
      fluidRow(column(width=6,numericInput("Fec_a_f_sss", "Lt-Fecundity: a in F=aL^b", value=0.00001,min=0, max=10000, step=-0.01)),
              column(width=6,numericInput("Fec_b_f_sss","Lt-Fecundity: b in F=aL^b", value=3,min=0, max=10000, step=0.01))),    
...
###########################
  shinyjs::hidden(wellPanel(id="Profile_panel",
    ...
    br(),
    br(),
    h5(em("If choosing multiple parameters to profile over, entries should be done in order of the parameters shown and separated by a comma (e.g., 0.1, 0.3).")),  
